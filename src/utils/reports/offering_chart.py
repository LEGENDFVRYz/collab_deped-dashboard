...
FILTERED_DF = dataframe = auto_extract(['counts','mod_coc','gender', 'region','es_grade','jhs_grade','shs_grade'], is_specific=False)
FILTERED_DF
...
number_of_schools_mcoc_chart.update_layout(
    ...
    plot_bgcolor='#FFFFFF',
    font=dict(family='Inter', color='#3C6382'),  # <<< Changed here
    legend=dict(
        title='Programs',
        font=dict(size=14),
        x=1,
...
##################################################################################
##  --- CHART: Gender Distribution Across MCOC Types
#################################################################################
# 1. Automatically extract 'counts' column for all grades (ES to SHS)
...
gender_distribution_chart.update_layout(
    ...
    font=dict(family='Inter', color='#3C6382'),
...
ranked_mcoc_chart.update_layout(
    title={
        ...
        'x': 0.5,
        'xanchor': 'center',
        'font': {'size': 26, 'family': 'Inter Black', 'color': '#3C6382'}
    },
...
region_stacked_chart.update_layout(
    title={
        ...
        'x': 0.5,
        'xanchor': 'center',
        'font': {'size': 24, 'family': 'Inter Black', 'color': '#3C6382'}
    },
    font={'family': 'Inter', 'size': 14, 'color': '#3C6382'},
    xaxis_title='Region',

...
def update_graph(base_trigger):
    ...
    BASE_DF = BASE_DF[BASE_DF['track'] != '__NaN__']
    BASE_DF['track'] = BASE_DF['track'].cat.remove_unused_categories()
...
def update_graph(base_trigger):
    ...
    BASE_DF['strand'] = BASE_DF['strand'].cat.remove_unused_categories()
